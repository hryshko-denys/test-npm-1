 ...
 */
export declare type StakePoolInstructionType = 'Initialize' | 'Deposit' | 'DepositSol' | 'WithdrawStake' | 'WithdrawStakeWithDao' | 'WithdrawSol' | 'SetFundingAuthority' | 'CreateCommunityTokenStakingRewards' | 'DepositSolDao' | 'WithdrawSolWithDao';
/**
